...
import static org.apache.flink.metrics.kafka.KafkaReporterOptions.CLUSTER;
import static org.apache.flink.metrics.kafka.KafkaReporterOptions.KEY_BY;
import static org.apache.flink.metrics.kafka.KafkaReporterOptions.SERVERS;
import static org.apache.flink.metrics.kafka.KafkaReporterOptions.TOPIC;
...
public class KafkaReporter implements MetricReporter, CharacterFilter, Scheduled {
    ...
    public void open(MetricConfig config) {
        ...
        for (Object keyObj : config.keySet()) {
            ...
            if (key.startsWith("prop.")) {//specified attr
    ...
    public void notifyOfAddedMetric(Metric metric, String metricName, MetricGroup group) {
        ...
        synchronized (this) {
            if (metric instanceof Counter) {
                ...
                log.warn(
                        "Cannot add unknown metric type {}. This indicates that the reporter does not support this metric type.",
    ...
    public void notifyOfRemovedMetric(Metric metric, String metricName, MetricGroup group) {
        synchronized (this) {
            if (metric instanceof Counter) {
                ...
                log.warn(
                        "Cannot remove unknown metric type {}. This indicates that the reporter does not support this metric type.",
                        metric.getClass().getName());
            }
        }
    }
